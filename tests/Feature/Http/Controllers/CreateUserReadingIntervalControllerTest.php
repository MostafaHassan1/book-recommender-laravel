...
test('throws validation error', function ($user, $book, $startPage, $endPage, $validationErrorKey) {
    ...
    'start page is bigger than the book\'s number_of_pages' => fn () => [
        User::factory()->create(),
        $book = Book::factory()->create(),
    ...
    'end page is bigger than the book\'s number_of_pages' => fn () => [
        User::factory()->create(),
        $book = Book::factory()->create(),
        1,
        $book->number_of_pages + 1,
    ...
    'end page is less than start page' => fn () => [
        User::factory()->create(),
        $book = Book::factory()->create(),
